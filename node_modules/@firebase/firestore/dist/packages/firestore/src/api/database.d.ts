...
import { clearIndexedDbPersistence, enableMultiTabIndexedDbPersistence } from '../../exp/src/api/database';
...
export declare class IndexedDbPersistenceProvider implements PersistenceProvider {
    enableIndexedDbPersistence(firestore: FirestoreCompat, forceOwnership: boolean): Promise<void>;
    enableMultiTabIndexedDbPersistence: typeof enableMultiTabIndexedDbPersistence;
    clearIndexedDbPersistence: typeof clearIndexedDbPersistence;
}
/**
 * The root reference to the database.
 */
export declare class Firestore implements PublicFirestore, FirebaseService, FirestoreCompat {
...
export declare function ensureFirestoreConfigured(firestore: FirestoreCompat): FirestoreClient;
export declare function configureFirestore(firestore: FirestoreCompat): void;
