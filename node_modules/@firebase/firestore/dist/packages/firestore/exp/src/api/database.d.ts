...
import { FirestoreCompat } from '../../../src/api/database';
 ...
 */
export declare class FirebaseFirestore extends LiteFirestore implements _FirebaseService, FirestoreCompat {
 ...
 */
export declare function enableIndexedDbPersistence(firestore: FirestoreCompat, persistenceSettings?: PersistenceSettings): Promise<void>;
/**
 ...
 * storage.
 */
export declare function enableMultiTabIndexedDbPersistence(firestore: FirestoreCompat): Promise<void>;
/**
 ...
 */
export declare function clearIndexedDbPersistence(firestore: FirestoreCompat): Promise<void>;
/**
