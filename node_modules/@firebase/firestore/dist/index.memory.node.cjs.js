...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.runTransaction = function (updateFunction) {
        var _this = this;
        var client = ensureFirestoreConfigured(this);
...
var WriteBatch = /** @class */ (function () {
    ...
    WriteBatch.prototype.commit = function () {
        ...
        if (this._mutations.length > 0) {
            var client = ensureFirestoreConfigured(this._firestore);
...
var DocumentReference = /** @class */ (function (_super) {
    ...
    function DocumentReference(_key, firestore, _converter) {
        ...
        _this._firestoreClient = ensureFirestoreConfigured(firestore);
        return _this;
    }
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.onSnapshot = function () {
        ...
        var client = ensureFirestoreConfigured(this.firestore);
    ...
    Query.prototype.get = function (options) {
        ...
        return (options && options.source === 'cache'
            ...
            : firestoreClientGetDocumentsViaSnapshotListener(client, this._query, options)).then(function (snap) { return new QuerySnapshot(_this.firestore, _this._query, snap, _this._converter); });
    };
    return Query;
}());
