...
class IndexedDbPersistenceProvider {
    constructor() {
        this.enableMultiTabIndexedDbPersistence = enableMultiTabIndexedDbPersistence.bind(null);
        this.clearIndexedDbPersistence = clearIndexedDbPersistence.bind(null);
    }
    enableIndexedDbPersistence(firestore, forceOwnership) {
...
class DocumentReference extends _DocumentKeyReference {
    ...
    get(options) {
        if (options && options.source === 'cache') {
            return firestoreClientGetDocumentFromLocalCache(this._firestoreClient, this._key).then(doc => new DocumentSnapshot(this.firestore, this._key, doc, 
            /*fromCache=*/ true, doc instanceof Document ? doc.hasLocalMutations : false, this._converter));
        }
        else {
            return firestoreClientGetDocumentViaSnapshotListener(this._firestoreClient, this._key, options).then(snapshot => this._convertToDocSnapshot(snapshot));
        }
    }
...
class Query {
    ...
    get(options) {
        ...
        return (options && options.source === 'cache'
            ...
            : firestoreClientGetDocumentsViaSnapshotListener(client, this._query, options)).then(snap => new QuerySnapshot(this.firestore, this._query, snap, this._converter));
    }
}
class QuerySnapshot {
